    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7x1 mx-auto'>
        <Link to="/" className='flex items-center gap-2' onClick={()=>{
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex '>Rahul &nbsp;<span className='sm:block hidden'>  | NITK</span></p>
        </Link>
...
{/* when screen shortens nav component will be hidden and when click it shows  */}
        <div className='sm:hidden flex flex-1 justify-end items-center'> 
            <img
            // understand this below src how it works
